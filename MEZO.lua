...
return {
Lock     = '[⧫ ℻ • 𝒄𝒓𝒊𝒔𝒕𝒊𝒏 𝒔𝒐𝒖𝒓𝒄𝒆 • ℻ ⧫](t.me/cristin_so)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه المسح *',
unLock   = '[⧫ ℻ • 𝒄𝒓𝒊𝒔𝒕𝒊𝒏 𝒔𝒐𝒖𝒓𝒄𝒆 • ℻ ⧫](t.me/cristin_so)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[⧫ ℻ • 𝒄𝒓𝒊𝒔𝒕𝒊𝒏 𝒔𝒐𝒖𝒓𝒄𝒆 • ℻ ⧫](t.me/cristin_so)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه الكتم *',
lockKid  = '[⧫ ℻ • 𝒄𝒓𝒊𝒔𝒕𝒊𝒏 𝒔𝒐𝒖𝒓𝒄𝒆 • ℻ ⧫](t.me/cristin_so)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه التقييد *',
lockKick = '[⧫ ℻ • 𝒄𝒓𝒊𝒔𝒕𝒊𝒏 𝒔𝒐𝒖𝒓𝒄𝒆 • ℻ ⧫](t.me/cristin_so)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه الطرد *',
Reply    = '[⧫ ℻ • 𝒄𝒓𝒊𝒔𝒕𝒊𝒏 𝒔𝒐𝒖𝒓𝒄𝒆 • ℻ ⧫](t.me/cristin_so)\n*— — — — — — — — —\n◍ المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
{
{text = '❍ 𓏶 𝒄𝒓𝒊𝒔𝒕𝒊𝒏 • 𝒔𝒐𝒖𝒓𝒄𝒆 𓏶 ❍', url='https://t.me/cristin_so'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(MEZO.."MEZO:Set:On"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(MEZO.."MEZO:Add:Rd:Sudo:Gif"..text..msg_chat_id)   
Redis:del(MEZO.."MEZO:Add:Rd:Sudo:Vico"..text..msg_chat_id)   
Redis:del(MEZO.."MEZO:Add:Rd:Sudo:Stekrs"..text..msg_chat_id)     
Redis:del(MEZO.."MEZO:Add:Rd:Sudo:Text"..text..msg_chat_id)   
Redis:del(MEZO.."MEZO:Add:Rd:Sudo:Photo"..text..msg_chat_id)
Redis:del(MEZO.."MEZO:Add:Rd:Sudo:Video"..text..msg_chat_id)
Redis:del(MEZO.."MEZO:Add:Rd:Sudo:File"..text..msg_chat_id)
Redis:del(MEZO.."MEZO:Add:Rd:Sudo:Audio"..text..msg_chat_id)
Redis:del(MEZO.."MEZO:Add:Rd:Sudo:video_note"..text..msg_chat_id)
Redis:del(MEZO.."MEZO:Set:Sudo:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(MEZO.."MEZO:List:Rd:Sudo"..msg_chat_id.."", text)
...
--download('https://raw.githubusercontent.com/PaythoneCR/server/master/MEZO.lua','MEZO.lua')
...
local mrt = LuaTele.getUser(MEZO)
...
{
{text = Grosupsw, url = 'https://t.me/cristin_so'}, 
},
{
{text = Usperos, url = 'https://t.me/cristin_so'}, 
},
}
...
elseif text == 'كريستين' or text == 'جيرسي' or text == 'كريستينا' then
...
return LuaTele.sendText(msg_chat_id,msg_id,' ❍┃ اليك قسم الالعاب من سورس كريستين ',"md",false, false, false, false, reply_markup)
end
...
local NamesBot = (Redis:get(MEZO.."MEZO:Name:Bot") or "كريستين")
local BotName = {
...
if text == (Redis:get(MEZO.."MEZO:Name:Bot") or "كريستين") then
local photo = LuaTele.getUserProfilePhotos(MEZO)
local mrt = LuaTele.getUser(MEZO)
for Name_User in string.gmatch(mrt.first_name, "[^%s]+" ) do
mrt.first_name = Name_User
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس كريستين؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس كريستين؟ ", 
"كم مره حبيت؟ ", 
...
local CmdStart = '*\n🤖╖   أهلآ بك عزيزي أنا بوت'..(Redis:get(MEZO.."MEZO:Name:Bot") or "كريستين")..
'\n🌐╢ وظيفتي حماية المجموعات'..
...
local TextHelp = [[*
❍┃ اليك قسم الالعاب من سورس كريستين🏴‍☠️
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
