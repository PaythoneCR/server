...
local N = (Redis:get(MEZO.."Name:Bot") or "كريستين")
...
if text == 'رفع النسخه العامه' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*✘︙ هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
...
if text == 'رفع نسختي القديمه' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ❍┃ هاذا الامر يخص ⟦ '..Controller_Num(1)..' ⟧* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
{
{text = 'مسح العام 🚨',type = 'text'},{text = 'مسح العام 🚨',type = 'text'},{text = 'مسح العام 🚨', type = 'text'},
},
{
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '•✠|??𝙰𝙲𝙺|✠•', data =UserId..'/'.. 'NoNextSeting'},},}}
